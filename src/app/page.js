...
import box1 from "../../public/home/box1.png";
import box2 from "../../public/home/box2.png";
import box3 from "../../public/home/box3.png";
import page from "../../public/home/page.png";
...
export default function Home() {
  ...
  const founders = [
    {
      name: "Jaiman Soni",
      role: "Co-founder",
      url: "https://www.linkedin.com/in/jaimansoni",
    },
    {
      name: "Swabhiman Nanda",
      role: "Co-founder",
      url: "https://www.linkedin.com/in/swabhiman-nanda",
    },
    {
      name: "Vimarsh Tiwari",
      role: "Co-founder",
      url: "https://www.linkedin.com/in/vimarsh2013",
    },
    {
      name: "Jenish Soni",
      role: "Co-founder",
      url: "https://www.linkedin.com/in/jenish-soni-a14174224",
    },
  ];
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="max-lg:min-h-[700px] z-[10000] min-h-screen bg-no-repeat max-lg:bg-contain bg-center flex justify-center items-center px-4 sm:px-6 md:px-8"
          style={{
