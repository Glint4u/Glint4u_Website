...
import { Marquee } from "../../ui/TechnologiesWeWork"; // Adjust the import path as needed
// import "./styles.css"; // Make sure to style appropriately or include required styles
